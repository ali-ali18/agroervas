...
export default function Contato() {
  return (
    <main className="flex flex-col items-center min-h-screen bg-gray-100 py-10 px-4">
      <h2 className="text-3xl font-bold mb-6 text-center text-gray-800">Entre em Contato</h2>

      {/* Formas de Contato */}
      <div className="mb-10">
        <h3 className="text-xl font-semibold text-gray-700 mb-4 text-center">Formas de Contato:</h3>
